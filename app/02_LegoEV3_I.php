...
/*
  EV3-Übersicht
  ---------------------------
  Zeigt alle EV3-Aufgaben aus tasks (category = 'ev3'),
...
<title>EV3 – Aufgabenübersicht</title>
<style>
body.page-width {
  max-width: 1100px;
...
<body class="page-width">
  ...
  <div class="topic-row">
    <div class="topic-btn">EV3 Basic Course (Grundkurs)</div>
    <div class="topic-btn">EV3 Advanced Course (Oberstufe)</div>
  </div>
